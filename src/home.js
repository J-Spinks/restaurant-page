...
export const generateHomePage = () => {
  ...
  overviewParaDiv.textContent = "At The Delicious Bistro, we serve fresh,locally sourced ingredients to create flavorful dishes that will delight your taste buds.";
